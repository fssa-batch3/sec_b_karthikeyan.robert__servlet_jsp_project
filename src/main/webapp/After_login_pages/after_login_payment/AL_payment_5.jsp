        ...
        <section class="payment_section">
            ...
            <div class="payment_left">
                ...
                <div class="left_row_3">
                    <input placeholder="Full Name" required class="mandatory_input">
                    <input placeholder="Email" required class="mandatory_input">
                    <input placeholder="Phone" required class="mandatory_input">
                </div>
                ...
                <div class="left_row_5">
                    <lable class="fullname_anonymous">
                        <input type="radio" name="contributor_name_display" value="full_name" checked="checked">
                        Full Name
                    </lable>
                    <lable class="fullname_anonymous">
                        <input type="radio" name="contributor_name_display" value="anonymous">
                        Well-Wisher
                    </lable>
                </div>
            ...
            <div class="payment_right">
                ...
                <div class="right_row_3">
                    ...
                    <p>
                        <img src="../../assets/images/rupee.png" alt="image" class="" width="15px" height="15px">1000
                    </p>
                
                </div>
                <div class="right_row_4">
                    <input id="KNfunding_tip" type="checkbox" value="yes">
                    Service Tips (Optional)
                    <select id="tip" name="tipamount">
                ...
                <div class="right_row_6">
                    <p>Total</p>
                    <p>
                        <img src="../../assets/images/rupee.png" alt="image" class="" width="15px" height="15px">1080
                    </p>
                </div>
                ...
                <div class="right_row_8">
                    <a class="" href="../../payment login page/card_details.html">    
