        ...
        <sevtion class="profile_heading2">
            <h2 class="heading">
                <ul class="backers_count">
                    ...
                    <a class=" about_backer" href="../after_login_backer/AL_backer_3.html">
                        <li>Backers (0)</li>
                    </a>
                </ul>
            </h2>
            ...
            <div class="profile">
                ...
                <div class="profile_left">
                    ...
                    <div class="profile_row_two">
                        <img src="../../assets/images/story_3.jpg" alt="image" class="" width="800px" height="500px">
                    </div>
                    <div class="profile_row_three">
                        <p>
                            <b>Ritanya De Sarkar, a 7 year old little angel is suffering from ALL B Type Leukemia need Bone Marrow transplant on urgent basis.</b>
                        </p>
                        <p>
                            We need save her life by helping her. I know that we can do this by giving our possible efforts.
                            Its a time to show that unity has a real power and even save a innocent life.
