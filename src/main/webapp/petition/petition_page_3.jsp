        ...
        <div class="information_page">
            ...
            <div class="Info">
                ...
                <div class="Basic_info">
                    Goal
                    <input type="number" class="option input_option">
            
                </div>
                <div class="Basic_info">
                    End date 
                    <input placeholder id="end_date" value aria-invalid="false" class="title input_option">
                ...
                <div class="end_method Basic_info">
                    ...
                    <div class="radio">
                        <lable class="m_radio">
                            <input type="radio" value="goal_achieve" name="end_goal">
                            After Goal Achievement
                            <span></span>
                        </lable>
                        <lable class="m_radio">
                            <input type="radio" value="end_date" name="end_goal">
                            After End Date
                            <span></span>
                        </lable>
                        <span>
            ...
            <div class="back_save ">
                ...
                <a href="../our profile/my_campaigns.html">
