        ...
        <div class="information_page">
            ...
            <div class="Info">
                <div class="Basic_info">
                    Short Description<textarea class="basic input_option"> </textarea>
                </div>
                <div class="Basic_info">
                    Category 
                    <input type="text" list="count" class="option input_option">
                ...
                <div class="Basic_info">
                    Title 
                    <input placeholder="keep your title within 200 characters" class="title input_option">

                </div>
                <div class="Basic_info">
                    Campaigner Name <input type="text" class="name input_option">

                </div>
                <div class="Basic_info">
                    Petition to<input type="text" class="petition_to input_option">

                </div>
            </div>
            <div class="continue">
                <center>
                    <a href="../petition/petition_page_2.html">
                        <button class="save_continue"> Save & Continue</button>
                    </a>
                </center>    
            </div>
