        ...
        <div class="information_page">
            ...
            <div class="Info">
                ...
                <div class="Basic_info">
                    Description<textarea class="basic input_option"> </textarea>
                </div>
                <div class="featured_image">
                    <lable class="image_title">Featured Image</lable>
                    <div class="image_button">
                    
                        <input placeholder="choose an image" class=" title input_option">
                        <input type="file" name="featured_image" class="choose_image" id="customfile" accept="image/*">
                    </div>    

                </div>
            </div>
            <div class="back_save ">
                <a href="../petition/petition_page_1.html">
                    <button class="back">BACK</button>
                </a>
            
                <a href="../petition/petition_page_3.html">
                    <button class="save save_continue"> Save & Continue</button>
                </a>
